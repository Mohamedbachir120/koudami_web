...
<div class="card">
                <div class="card-header text-center bg-dark text-light">  
                    ...
                    <h4><i class="fa fa-home"></i> Ajout d'un offre d'emploi</h4>
                ...
                <div class="card-body d-flex flex-column align-items-left">
                    ...
                    @endif
                    <form action="/jobs/store_article" enctype="multipart/form-data" method="post" class="col-lg-8 d-flex flex-column flex-wrap p-4 shadow rounded">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div>
                                <input type="text" name="emploi" class="form-control" id="emploi">
                        ...
                        <div class="form-group row">
                            ...
                            <div>
                                <input type="number" name="salaire" class="form-control" id="salaire" min="0">
                        ...
                        <div class="form-group">
                          ...
                          <div>
                            <textarea name="contact" class="form-control" id="contact" cols="30" rows="10"></textarea>  
