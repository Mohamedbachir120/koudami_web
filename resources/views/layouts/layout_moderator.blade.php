                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3 flex-fill">
                        ...
                        <li class="d-flex flex-row align-items-end p-2 bg-dark text-light rounded my-1">  
                            ...
                            <img src="{{ Auth::user()->photo}}" width="80px" height="80px" alt="">  
                            @else
                                
                            <img src="/css/avatar.png" width="80px" height="80px" alt="">  
                            ...
                            <li><a href="{{ route('show_comments') }}" class="btn btn-outline-dark tex-center w-100 mt-1"><i class="fa fa-eye"></i>  Consulter les commentaires</a></li>
                            <li>  <a href="{{ route('index_quittance') }}" class="btn btn-outline-dark tex-center w-100 mt-1"><i class="fa fa-eye"></i> Consulter  les quittances reçues  </a></li>
                            <li>  <a href="{{ route('show_users') }}" class="btn btn-outline-dark tex-center w-100 mt-1"><i class="fa fa-users"></i> Afficher touts les utilisateurs  </a></li>
                            <li><a href="/messagerie" class="btn btn-outline-dark tex-center w-100 mt-1"><i class="fa fa-weixin"></i> Messagerie </a></li>
                            <li><a href="/detail_moderator/{{ Auth::user()->id}}" class="btn btn-outline-dark tex-center w-100 mt-1"><i class="fa fa-book"></i> Mes informations</a></li>
                            <li><a href="/edit_password/{{ Auth::user()->id }}" class="btn btn-outline-dark tex-center w-100 mt-1"><i class="fa fa-key"></i> Mot de passe </a> </li>
