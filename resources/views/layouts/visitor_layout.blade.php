...
<body>
    <div id="app">
        ...
        <main class="py-4">
            ...
            <li><a href="/fr/our_clients" class="btn btn-outline-dark w-100 mt-1"><i class="fa fa-eye"></i> Voir les services disponibles</a></li>
            <li><a href="/detail_visitor/{{ Auth::user()->id}}" class="btn btn-outline-dark mt-1 w-100"><i class="fa fa-book"></i> Consulter mes informations</a></li>
            <li><a href="/edit_password/{{ Auth::user()->id }}" class="btn btn-outline-dark mt-1 w-100"><i class="fa fa-key"></i> Modifier mot de passe </a> </li>
