  ...
  <div class="row">
    ...
    <main role="main" class="col-md-12 ml-sm-auto col-lg-10  mt-3 pl-lg-5 mb-5">
                        ...
                        <div class="card">
                            ...
                            <div class="d-flex flex-row-reverse flex-wrap m-4 justify-content-center align-items-center">
                            ...
                            <form class="p-4" action="{{ route('edit_article_image',$article)}}" enctype="multipart/form-data" id="myform" method="post">
                                ...
                                <div class="form-group row" hidden>
                                  ...
                                  <label for="pic1"><i class="fa fa-picture-o"></i> الصورة  : 01 &nbsp; </label>
                                 
                                </div>
                               <div class="form-group row" hidden>
                                <input type="file" name="pic2" class="photo"  id="pic2"   accept="image/*">
                                <label for="pic2"><i class="fa fa-picture-o"></i> الصورة  : 02 &nbsp; </label>
                               
                               </div>
                               <div class="form-group row" hidden>
                                <input type="file" name="pic3" class="photo"  id="pic3"  accept="image/*">
                                <label for="pic3"><i class="fa fa-picture-o"></i> الصورة  : 03 &nbsp; </label>
                        ...
                        <form action="{{ route('update_article',$article) }}" enctype="multipart/form-data" method="post" class="col-lg-8 d-flex flex-column align-items-end flex-wrap p-4 shadow rounded">
                            @csrf
                        ...
                        <select name="livraison" id="livraison" class="selectpicker">
                            ...
                            <option value="disponible" selected>متوفر</option>
                            <option value="non disponible">غير متوفر</option>
                            @else
                            <option value="disponible" >متوفر</option>
                            <option value="non disponible" selected>غير متوفر</option>
